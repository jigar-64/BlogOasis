...
<img class="h-auto max-w-lg transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0" src=".\admin\assets\images\blog\<?php echo $blog['blog_image']; ?>" alt="image description">
