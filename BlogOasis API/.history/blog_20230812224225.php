...
<img class="h-auto max-w-full" src=".\admin\assets\images\blog\<?php echo $blog['blog_image']; ?>" alt="image description">

                    <img src=".\admin\assets\images\blog\<?php echo $blog['blog_image']; ?>" class="w-full h-auto max-w-xl rounded-lg" alt="image description">
                        </div>
