                ...
                <div class="container bg-white">
                    ...
                    <img src=".\admin\assets\images\blog\<?php echo $blog['blog_image']; ?>" class="w-full h-auto max-w-xl rounded-lg blogimg" alt="image description">
                        ...
                        <div class="blogContent ">
                           ...
                           <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400"><?php echo $blog['blog_content']; ?></p>
                           </div>
                           <div class="author ">
                            <p class="text-center">~<?php echo $blog['user_name']; ?></p>
                           </div>
                        </div>
