...
<body>
    ...
    <!-- footer -->
    <footer
        class="  w-full p-4 transperentBackground border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
