...
<!-- Card 1 -->
    ...
    <a href="blog.php?id=<?php echo $blog['blog_id']; ?>"><img src=".\admin\assets\images\blog\<?php echo $blog['blog_image']; ?>" alt="Blog Image"
            class="w-full h-48 object-cover">
            </a>
        <div class="p-4">
            <h2 class="text-xl font-semibold text-gray-800 mb-2">
            <a href="blog.php?id=<?php echo $blog['blog_id']; ?>"> <?php echo $blog['blog_title']; ?></a> 
            </h2>
            <p class="text-gray-600">
                <?php echo $blog['blog_description']; ?>.
            </p>
            <div class="mt-4">
                <a href="blog.php?id=<?php echo $blog['blog_id']; ?>" class="text-blue-500 hover:underline">Read more</a>
            </div>
        </div>
    </div>
...
<?php }; ?>
        ...
        $sql1 = "SELECT * FROM blogpost";
                        ...
                        if(mysqli_num_rows($result1) > 0){
                          ...
                          for($i = 1; $i <= $total_page; $i++){
                            ...
                            echo '<a href="index.php?page='.$i.'" class="px-3 py-2 bg-blue-500 text-white hover:bg-blue-600">'.$i.'</a>';
                          }
                          if($total_page > $page){
    ...
    <!-- footer -->
    <footer
        class=" z-20 w-full p-4 transperentBackground border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
