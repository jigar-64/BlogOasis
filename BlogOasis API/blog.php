...
<body>
    ...
    <main>
        <div class="container mx-auto ">
                ...
                <?php
                        ...
                        $blog_id = $_GET['id'];
                        $query = "SELECT * FROM blogpost WHERE blog_id = ?";
                        ...
                        // Process your blog data
                   ?>
                
                <div class="Blogcontainer">
                    <div class="blogImage mt-3.5">                           
                    <img src=".\admin\assets\images\blog\<?php echo $blog['blog_image']; ?>" class="w-full h-auto max-w-xl rounded-lg blogimg" alt="image description">
                        </div>

                        <div class="blogContent ">
                            <div class="blogTitle my-6">
                               <h2 class="text-4xl font-extrabold dark:text-white"><?php echo $blog['blog_title']; ?></h2>
                           </div>
                           <div class="description">
                           <p class=" text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400"><?php echo $blog['blog_content']; ?></p>
                           <p class="blogAuth">~<?php echo $blog['user_name']; ?></p>
                           </div>                           
                        </div>
                </div>
            ...
            <div class="comment bg-white mb-6">
                    
                <form action="./admin/pages/crud/addcomment.php" method="post">
                    <div><input type="hidden" name="blog_id" value="<?php echo $blog_id = $_GET['id'];?>"></div>
                <div class="mb-6">
                ...
                <button type="submit" name="comment_post" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Commnet Now</button>
                </form>
    ...
    <!-- footer -->
    <footer
        class=" bottom-0 left-0 z-20 w-full p-4 transperentBackground border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">

        <span class="text-sm  sm:text-center dark:text-gray-400"> © 2023 <a href="#"
                class="hover:underline">BLogOasis™</a>. All Rights Reserved.
        </span>
